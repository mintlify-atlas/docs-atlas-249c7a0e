...
<ParamField path="endDate" type="DateInput" required>
...
<ParamField path="options.inclusivity" type="string" optional>
...
<ParamField path="options.format" type="string | Intl.DateTimeFormatOptions" optional>
...
<ResponseField name="return" type="TemporalWrapper[] | string[]">
