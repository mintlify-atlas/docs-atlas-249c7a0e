...
const metrics = atemporal.Atemporal.getFormattingMetrics();
console.log(metrics);
/*
{
  totalFormats: 1543,
...
const report = atemporal.Atemporal.getFormattingPerformanceReport();
console.log(report);
/*
...
atemporal.Atemporal.resetFormattingSystem();

// Pre-warm with common patterns
atemporal.Atemporal.prewarmFormattingSystem();
```
